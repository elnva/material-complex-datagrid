export default [
      ...
      checked_pre_flight_checks: [
        {
          images: [
            {
              path:
                "operations/c70c8592-3c5e-4203-af7c-cb74300a4dc1/pre_flight_checks/1898c571-56e2-4d04-97ca-fc753b2bdc86.png",
              title: "PFC1.png"
            }
          ],
        ...
        },
        {
          images: [
            {
              path:
                "operations/c70c8592-3c5e-4203-af7c-cb74300a4dc1/pre_flight_checks/30d5eb54-9219-404a-8108-8b2d2b6ce3d2.png",
              title: "PFC2.png"
            }
          ],
  ...
  },
  {
    ...
    job_event_metadata: {
      causes: {
        Design: ["Coordination", "Drawing Issues"]
      },
      device: {
        station: {
          zone_name: "Bench - Panels",
    ...
    job_event_metadata: {
      ...
      in_process_check: {
        ...
        images: [
          {
            path:
              "operations/c70c8592-3c5e-4203-af7c-cb74300a4dc1/standard_work_instructions/ada952b1-1789-4c0a-9cb4-a55a1971319f.png",
    ...
    job_event_metadata: {
      ...
      in_process_check: {
        ...
        images: [
          {
            path:
              "operations/c70c8592-3c5e-4203-af7c-cb74300a4dc1/standard_work_instructions/43080763-5f78-4f67-9767-d915f2b86999.png",
    ...
    job_event_metadata: {
      ...
      in_process_check: {
        ...
        images: [
          {
            path:
              "operations/c70c8592-3c5e-4203-af7c-cb74300a4dc1/standard_work_instructions/f1a94ddb-e456-4846-ae37-9d3ad90a9010.png",
  ...
  },
  {
    ...
    job_event_metadata: {
      ...
      in_process_check: {
        ...
        images: [],
        content:
          "Ensure the floor is square and in line with drawing requirements",
  ...
  },
  {
    ...
    job_event_metadata: {
      ...
      in_process_check: {
        ...
        images: [],
        content:
          "Ensure the vapour barrier has been installed as per drawing requirements",
